...
namespace Illuminate\Routing {
    ...
    class Route {
        /**
         * @see \G4T\Swagger\SwaggerServiceProvider::register()
         * @param mixed $description
         * @static
         */
        public static function description($description)
        {
            return \Illuminate\Routing\Route::description($description);
        }
        ...
        {
            return \Illuminate\Routing\Route::summary($summary);
        }
         ...
         * @static
         */
        public static function hiddenDoc()
        {
            return \Illuminate\Routing\Route::hiddenDoc();
        }
