...
class Project extends Model
{
    ...
    {
        return $this->hasMany(ProjectModule::class)->latest();
    }

    public function ProjectPlanning()
    {
        return $this->hasMany(ProjectPlanning::class)->latest();
    }
    ...
    public function projectManpower(){
